# File: modules\organization\pages\create-organization copy 3.tsx

## Location
`G:/Projects/doctor_lab/medic_hub_gemini/apps/web/src/modules/organization/pages/create-organization copy 3.tsx`

## Category
Frontend

## File Type
TSX (create-organization copy 3.tsx)

## Size
57501 characters, 892 lines
            ...
            <div className='flex min-h-0 flex-1 flex-col overflow-y-auto p-2 md:p-4'>
                <div className='mx-auto flex w-full max-w-[1520px] flex-col gap-4'>
                    ...
                    <header className='flex w-full flex-col gap-4 px-1 sm:flex-row sm:items-start'>
                        <div className='self-start pt-[3px]'>
                            {mode === 'specialist' ? (
                        ...
                        <div className='flex w-full flex-col gap-1'>
                            <div className='flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center'>
                                <h1 className='text-text text-h4 sm:text-h3 min-w-fit font-medium'>{title} Setup</h1>
                            ...
                            <p className='text-text-secondary text-p md:text-text- max-w-3xl text-sm'>
                                {mode === 'specialist'
                    ...
                    <div className='flex flex-col gap-4 px-1 pb-4 lg:flex-row'>
                        ...
                        <div className='flex min-w-0 flex-1 flex-col gap-4 xl:flex-row'>
                            ...
                            <Card className='h-fit w-full flex-1 gap-2 py-4 lg:max-w-3xl'>
                                ...
                                <CardContent className='flex flex-col gap-4 px-4'>
                                    ...
                                    <div className='flex w-full flex-col gap-3'>
                                        ...
                                        {/* ИСПРАВЛЕНИЕ ЗДЕСЬ: Добавлено min-w-0 для flex-контейнеров внутри grid */}
...
*Auto-generated documentation - Last updated: 2025-12-11T12:41:20.126Z*
